...
public class TyrantBot8 : IChessBot
{
    ...
    public (ulong, Move, int, int, int)[] HistoryTable = new (ulong, Move, int, int, int)[0x400000];

    public readonly Move[] Killers = new Move[2048];
    public readonly int[] MoveScores = new int[218];

    // Reset history tables
    public int[,,] HistoryHeuristics = new int[2, 7, 64];
    ...
    public int PVS(int depth, int plyFromRoot, int alpha, int beta, bool allowNull)
    {
        ...
        ref var entry = ref HistoryTable[zobristKey & 0x3FFFFF];
