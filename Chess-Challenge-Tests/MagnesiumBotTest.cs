...
public class MagnesiumBotTest
{
    private MagnesiumBot _bot;
    ...
    public void TestPuzzle1()
    {
        ...
        int score = _bot.Search(_testBoard, 6, 0, -100000, 100000);
    ...
    public void TestPuzzle2()
    {
        ...
        int score = _bot.Search(_testBoard, 4, 0, -100000, 100000);
    ...
    public void TestPuzzle5()
    {
        ...
        int score = _bot.Search(_testBoard, 10, 0, -100000, 100000);
    ...
    public void TestPuzzle6()
    {
        ...
        int score = _bot.Search(_testBoard, 8, 0, -100000, 100000);
    ...
    public void TestPuzzle7()
    {
        ...
        Assert.That(_bot.BestMove.TargetSquare.Name, Is.EqualTo("e5"));
    ...
    public void TestPuzzle9()
    {
        ...
        int score = _bot.Search(_testBoard, 9, 0, -100000, 100000);
    ...
    public void TestMoveOrdering()
    {
        ...
        int score = _bot.Search(_testBoard, 1, 0, -100000, 100000);
